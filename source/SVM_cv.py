...
#
print(f'\nTraining...\n')
scores = cross_val_score(clf, X_train, y_train, cv=5, verbose=3, n_jobs=-1)
print(f'Cross validataion score:\n{pd.Series(scores)}\n')
print(f'Cross validataion score(mean): {scores.mean()}')
print(f'Cross validataion score(sd)  : {scores.std()}')
